...
const EditFamilyDetails = ({ member, onSave, onCancel }) => {
  ...
  const validateForm = () => {
    ...
    ["firstname", "middlename", "lastname", "fatherName"].forEach((field) => {
      if (!formValues[field]) {
        validationErrors[field] = `${field} is required.`;
      } else if (!/^[A-Za-z ]+$/.test(formValues[field])) {
        validationErrors[field] = "Only characters are allowed.";
      } else if (formValues[field].length < 4) {
        validationErrors[field] = `${field} must be at least 4 characters.`;
...
//CountryCode
    ...
    if (!formValues.phoneNumber) {
      ...
      validationErrors.phoneNumber = "Phonenumber must be 10 digits.";
    }
    ...
    // } else if (currentDate.getFullYear() - dobDate.getFullYear() > 100) {
    ...
    // Date of Joining
    const joiningDate = new Date(formValues.dateOfJoining);
    if (!formValues.dateOfJoining) {
      validationErrors.dateOfJoining = "Date is required.";
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center">
      <div className="bg-gray-200 p-4 rounded-md shadow-md w-1/2  ">
        <div className="bg-orange-400 rounded-md p-1 mb-10 flex items-center justify-between">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-4 gap-6 mb-9">
            ...
            <div>
              ...
              />
              {errors.firstname && (
                <span className="text-red-800 block h-4">{errors.firstname}</span>
              )}
            </div>
            {/* Middle Name */}
            <div>
              ...
              />
              {errors.middlename && (
                <span className="text-red-800 block h-2">{errors.middlename}</span>
              )}
            </div>
            {/* Last Name */}
            <div>
              ...
              />
              {errors.lastname && (
                <span className="text-red-800 block h-2">{errors.lastname}</span>
              )}
            </div>
          </div>
          ...
          */}
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                />
                {errors.phoneNumber && (
                  <span className="text-red-800 block h-4">{errors.phoneNumber}</span>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              {errors.maritalStatus && (
                <span className="text-red-800 block h-4">{errors.maritalStatus}</span>
              )}
            </div>
            {/* Date of Birth */}
            <div>
              ...
              <input
                ...
                className="w-full p-1 border border-gray-300 rounded-md"
              />
              {errors.dob && <span className="text-red-800 block h-4">{errors.dob}</span>}
            </div>
          ...
          <div>
            ...
            <div>
              ...
              />
              {errors.fatherName && (
                <span className="text-red-800 block h-4">{errors.fatherName}</span>
              )}
            </div>
            {/* Date of Joining */}
            <div>
              ...
              {errors.dateOfJoining && (
                <span className="text-red-800 block h-4">{errors.dateOfJoining}</span>
              )}
            </div>
            {/* Blood Group */}
            <div>
              ...
              />
              {errors.bloodGroup && (
                <span className="text-red-800 block h-4">{errors.bloodGroup}</span>
              )}
            </div>
          </div>
